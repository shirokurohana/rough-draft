  ...
  */
  ...
  var DrawBounds = function DrawBounds(graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      color = GetValue$K(config, 'color', 0xffffff);
  ...
  var ComponentBase = /*#__PURE__*/function () {
    function ComponentBase(parent, config) {
      ...
      this.setEventEmitter(GetValue$H(config, 'eventEmitter', true)); // Register callback of parent destroy event, also see `shutdown` method
  ...
  var TickTask = /*#__PURE__*/function (_ComponentBase) {
    ...
    function TickTask(parent, config) {
      ...
      _this.setTickingMode(GetValue$G(config, 'tickingMode', 1)); // boot() later
  ...
  Object.assign(methods$4, PaddingMethods, AddChildMethods$1, RemoveChildMethods$1, GetParentSizerMethods, ScaleMethods, FadeMethods, EaseMoveMethods, ShakeMethods, EaseDataMethods, ClickMethods, TouchingMethods, HideMethods, GetShownChildrenMethods);
  ...
  var Add = function Add(gameObject, proportion, align, paddingConfig, expand, childKey, index, minSize) {
    ...
    if (proportion === null) {
      ...
      proportion = GetValue$i(config, 'proportion', 0);
      ...
      if (!gameObject.isRexSizer) {
        ...
        if (this.orientation === 0) {
          // x
          minSize = GetValue$i(config, 'minWidth', undefined);
        } else {
          // y
          minSize = GetValue$i(config, 'minHeight', undefined);
        }
      }
    }
  ...
  var Slider$1 = /*#__PURE__*/function (_Sizer) {
    ...
    function Slider(scene, config) {
      ...
      _this.setEaseValuePropName('value').setEaseValueDuration(GetValue$f(config, 'easeValue.duration', 0)).setEaseValueFunction(GetValue$f(config, 'easeValue.ease', 'Linear'));
  ...
  var Table = /*#__PURE__*/function () {
    ...
    _createClass(Table, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setDefaultCellHeight(GetValue$7(o, 'cellHeight', 30));
        this.setDefaultCellWidth(GetValue$7(o, 'cellWidth', 30));
  ...
  var GridTable$1 = /*#__PURE__*/function (_ContainerLite) {
    ...
    function GridTable(scene, x, y, width, height, config) {
      ...
      _this.setClampMode(GetValue$5(config, 'clamplTableOXY', true)); // Pre-process cell size


      if (_this.scrollMode === 0) {
        // scroll y
        var cellWidth = GetValue$5(config, 'cellWidth', undefined);
        _this.expandCellSize = cellWidth === undefined;

        if (cellWidth === undefined) {
          var columns = GetValue$5(config, 'columns', 1);
          config.cellWidth = _this.width / columns;
        }
      } else {
        // scroll x
        // Swap cell width and cell height
        var cellWidth = GetValue$5(config, 'cellHeight', undefined);
        var cellHeight = GetValue$5(config, 'cellWidth', undefined);
        _this.expandCellSize = cellWidth === undefined;
